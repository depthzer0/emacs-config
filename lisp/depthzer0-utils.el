;;; depthzer0-utils.el --- Самописные утилиты и функции -*- lexical-binding: t; -*-

;;; Commentary:
;; Библиотека императивных функций и скриптов для обслуживания Emacs.
;; В отличие от файлов в папке settings/, здесь нет вызовов use-package.
;; Только чистый Elisp-код, макросы и алгоритмы.
...
(provide 'depthzer0-utils)
;;; depthzer0-utils.el ends here
