...
(def-doom-theme doom-dark++
  ...
  ((bg         '("#1e1e1e" "#1e1e1e" nil))
   ...
   (accent-violet '("#4f318c" "#4f318c" "black"))
   ...
   ;; custom categories
   (modeline-bg    accent-violet)
   (modeline-bg-alt (doom-darken accent-violet 0.45))
   (modeline-fg     (doom-darken base8 0.2))
   (modeline-fg-alt (doom-darken blue 0.2))
